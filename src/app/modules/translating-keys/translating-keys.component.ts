...
@Component({
  selector: 'app-translating-keys',
  templateUrl: './translating-keys.component.html',
  styleUrls: ['./translating-keys.component.scss'],
})
export class TranslatingKeysComponent implements OnInit {
  navLinks = [];
  currentLang = '';
  baseUrl = '/translating-keys/';
  constructor(
