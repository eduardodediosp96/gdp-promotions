...
export const config = {
  ...
  dataTable: {
    tableId: 'TRANSLATINGIDENTS',
    columns: [
      { header: 'Identificacion ID', align: 'left', key: 'identId', width: '60', show: true },
      { header: 'Nombre', align: 'left', key: 'name', width: '160', show: true },
      { header: 'Descripcion', align: 'left', key: 'description', width: '60', show: true },
